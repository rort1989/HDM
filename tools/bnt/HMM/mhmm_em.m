...
% ~ Modified by Rui @ 2015/12/04
% 'cov_prior' - prior added to covariance matrix [0]
% ~ accordingly changed line 43,45 and 87
%
...
[max_iter, thresh, verbose, cov_type, cov_prior, adj_prior, adj_trans, adj_mix, adj_mu, adj_Sigma] = ...
    process_options(varargin, 'max_iter', 10, 'thresh', 1e-4, 'verbose', 1, ...
		    'cov_type', 'full', 'cov_prior', 0, 'adj_prior', 1, 'adj_trans', 1, 'adj_mix', 1, ...
