function [params_est, params_ini, LLtrace] = learn_params_HMM_BNT_(dataset, hstate_num, feature_dim, discrete, varargin)
...
addOptional(p,'cov_prior',default_prior,@isnumeric);
...
if ~discrete
    ...
    [LLtrace, prior, transmat, obsmat] = dhmm_em(datacells, prior0, transmat0, obsmat0, 'max_iter', max_iter, 'thresh', thresh);
end
